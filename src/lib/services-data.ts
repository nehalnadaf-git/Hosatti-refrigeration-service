...
export const SERVICES: Service[] = [
  // ── Refrigerator ───────────────────────────────
  {
    ...
    fullDesc: "We diagnose and fix all reasons a refrigerator stops cooling — faulty thermostat, blocked condenser coils, compressor issues, refrigerant leaks, and more. Quick service.",
    ...
    metaDesc: "Expert refrigerator not cooling repair in Dharwad. Quick service. All brands. Call Hosatti Refrigeration.",
  ...
  // ── Air Conditioner ────────────────────────────
  {
    ...
    metaDesc: "AC not cooling repair in Dharwad. Quick service, all brands. Hosatti Refrigeration.",
  ...
  // ── Air Cooler ─────────────────────────────────
  {
    ...
    fullDesc: "We repair all air cooler brands — replacing dry cooling pads, fixing water pumps, clearing blocked nozzles, and repairing fans. Fast, quick service.",
    category: "air-cooler",
    categoryLabel: "Air Cooler",
    image: "/services/Air Cooler Not Cooling Repair.webp",
    metaTitle: "Air Cooler Repair Dharwad | Hosatti",
    metaDesc: "Air cooler not cooling repair in Dharwad. All brands. Quick service. Hosatti Refrigeration.",
  ...
  },
  {
    ...
    fullDesc: "We service semi-automatic washing machines — spinner issues, pulsator failure, timer problems, pump blockages, and lid switch faults. Quick service available.",
    category: "washing-machine",
    categoryLabel: "Washing Machine",
    image: "/services/Semi-Automatic Washing Machine Repair.webp",
    metaTitle: "Semi-Automatic Washing Machine Repair Dharwad | Hosatti",
    metaDesc: "Semi-automatic washing machine repair in Dharwad. Fast, quick service. Hosatti Refrigeration.",
  ...
  },
  {
    ...
    metaDesc: "Washing machine not draining? Expert repair in Dharwad. Quick service. Hosatti Refrigeration.",
  ...
  },
  {
    ...
    shortDesc: "Quick drain diagnosis and quick fix for all brands.",
