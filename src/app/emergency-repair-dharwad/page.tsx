              ...
              <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-10">
                ...
                <div className="rounded-2xl border-2 border-yellow-400/30 bg-yellow-400/5 p-6 text-center shadow-sm">
                  ...
                  <a href={waUrl} target="_blank" rel="noopener noreferrer"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl py-3 font-body font-bold text-[13px] uppercase tracking-[0.07em] transition-all hover:-translate-y-0.5"
                    style={{ background: "linear-gradient(135deg,hsl(37,92%,52%),hsl(30,98%,45%))", color: "hsl(216,50%,10%)" }}
                  >
                    💬 WhatsApp Us
                  </a>
                </div>
